...
public class TodayEventsListAdapter extends RecyclerView.Adapter<TodayEventsListAdapter.EventsViewHolder> {
    ...
    public TodayEventsListAdapter(Context context,
    ...
    @Override
    public TodayEventsListAdapter.EventsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_events_today, parent, false);
        return new TodayEventsListAdapter.EventsViewHolder(view, itemClickListener);

    }

    @Override
    public void onBindViewHolder(final TodayEventsListAdapter.EventsViewHolder holder, final int position) {
...
//////////////////---------------------->
    ...
    public static class EventsViewHolder extends RecyclerView.ViewHolder {
        ...
        public EventsViewHolder(View itemView, final ItemClickListener itemClickListener) {
            ...
            cardView = (CardView) itemView.findViewById(R.id.card_view_events_today);
            tvTitle = (TextView) itemView.findViewById(R.id.title_events_today);
            tvDescription = (TextView) itemView.findViewById(R.id.tv_description_events_today);
            tvDate = (TextView) itemView.findViewById(R.id.tv_date_events_today);
